...
//
// TODO: If a malicious individual sends a very large buffer,
// shouldn't this buffer be handled directly in the socket instead of waiting
// for it to reach the HTTP protocol to truncate the request?
//
//
