...
openssl req -new -x509 -days 3650 -subj '/C=SP/ST=Barueri/L=Minsk/O=Smattch Server/OU=Smattch Server unit/CN=localhost' -key ca.key -out ca.crt
...
openssl req -new -subj '/C=SP/ST=Barueri/L=Minsk/O=Smattch Server/OU=Smattch Server unit/CN=localhost' -key server.key -out server.csr
